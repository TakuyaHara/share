export default function() {
  ...
  const functionExpressionAnonymous51 = function(
    foo = "=>", 
    bar = "()"
    ) { return "foo"; };
  ...
  const functionExpressionNamed1 = function functionExpressionNamed1(

  ) { return "foo"; };
  const functionExpressionNamed2 = function functionExpressionNamed2(
  ...
  const functionExpressionNamed41 = function functionExpressionNamed41(
    foo, 
    bar
    ) { return "foo"; };
  const functionExpressionNamed42 = function functionExpressionNamed42(
    foo, 
    bar
    ) {
    return "foo";
  ...
  const functionExpressionNamed51 = function functionExpressionNamed51(
    foo = "=>", 
    bar = "()"
    ) { return "foo"; };
  const functionExpressionNamed52 = function functionExpressionNamed52(
    foo = "=>", 
    bar = "()"
    ) {
    return "foo";
