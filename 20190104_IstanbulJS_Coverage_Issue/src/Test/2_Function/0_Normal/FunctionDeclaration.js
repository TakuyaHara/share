export default function() {
  function functionDeclaration1() { return "foo"; };
  function functionDeclaration2() {
    return "foo";
  };
  
  function functionDeclaration11(foo, bar) { return "foo"; };
  ...
  function functionDeclaration31() { return "foo"; };
  function functionDeclaration32() {
    return "foo";
  };
  
  function functionDeclaration41(foo, bar) { return "foo"; };
  function functionDeclaration42(foo, bar) {
    return "foo";
  };
  
  function functionDeclaration51(foo = "=>", bar = "()") { return "foo"; };
